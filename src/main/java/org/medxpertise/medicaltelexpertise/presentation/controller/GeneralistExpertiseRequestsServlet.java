...
@WebServlet("/generalist/expertise-requests")
public class GeneralistExpertiseRequestsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
        ...
        if (user instanceof Doctor) {
            ...
            req.setAttribute("expertiseRequests", expertiseRequests);
            req.setAttribute("doctor", doctor);
        }
        
        req.getRequestDispatcher("/WEB-INF/views/generalist/expertise-requests.jsp").forward(req, resp);
    }
}
